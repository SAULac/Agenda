	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6" style="background-color: #FF3341; border: 5px solid blue;">
				...
				<label for="concepto" class="form-control">Saul Salvador ávila Coello</label>
				<label for="monto">telefono:</label>
				<label for="concepto" class="form-control">5576026701</label>
				<label for="fecha">Correo:</label>
				<label for="concepto" class="form-control">saulsalvadorac@gmail.com</label>
			</div>
		</div>
	</div>
</body>
